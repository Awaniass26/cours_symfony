 ...
 */
final class Version20241103234351 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, compte_id INT DEFAULT NULL, surname VARCHAR(20) NOT NULL, telephone VARCHAR(15) NOT NULL, adresse VARCHAR(25) NOT NULL, UNIQUE INDEX UNIQ_C7440455E7769B0F (surname), UNIQUE INDEX UNIQ_C7440455450FF010 (telephone), UNIQUE INDEX UNIQ_C7440455F2C56620 (compte_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
